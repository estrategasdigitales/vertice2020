...
<div class="woocommerce-order">
	...
	<?php if ( $order ) : ?>
		...
		<?php if ( $order->has_status( 'failed' ) ) : ?>
			...
			<p class="woocommerce-notice woocommerce-notice--error woocommerce-thankyou-order-failed-actions">
				...
				<?php if ( is_user_logged_in() ) : ?>
					<a href="<?php echo esc_url( wc_get_page_permalink( 'myaccount' ) ); ?>" class="button pay"><?php esc_html_e( 'Mi Cuenta', 'visual-composer-starter' ); ?></a>
				<?php endif; ?>
			</p>
		...
		<?php else : ?>
			<h2 class="vct-thank-you-title">
				...
				echo apply_filters( 'woocommerce_thankyou_order_received_text', esc_html__( 'Gracias, recibimos tu pedido.', 'visual-composer-starter' ), $order );
				?>
			</h2>
		...
		<div class="vct-thank-you-footer">
			<a href="<?php echo esc_url( home_url( '/' ) ); ?>">
				<?php esc_html_e( 'Regresar al sitio', 'visual-composer-starter' );
				?>
			</a>
		</div>
	...
	<?php else : ?>
		...
		<p class="woocommerce-notice woocommerce-notice--success woocommerce-thankyou-order-received">
			<?php
			// @codingStandardsIgnoreLine
			echo apply_filters( 'woocommerce_thankyou_order_received_text', esc_html__( 'Gracias, recibimos tu pedido.', 'visual-composer-starter' ), null );
			?>
		</p>
