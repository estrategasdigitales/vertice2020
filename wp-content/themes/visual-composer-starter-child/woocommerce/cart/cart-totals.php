	...
	<?php if ( wc_coupons_enabled() ) { ?>
		<div class="vct-promo">
			<button id="vct-show-promo-form" class="vct-show-promo-form">
				<?php esc_html_e( '¿Tienes un descuento?', 'visual-composer-starter' ); ?>
			</button>
			<div class="vct-promo-content" style="display:none;">
				<input type="text" class="input-text " name="vct-promo-code" id="vct-promo-code">
				<button id="vct-apply-promo-code" class="vct-checkout-button"><?php esc_html_e( 'Aplicar', 'visual-composer-starter' ); ?></button>
			</div>
		</div>
	<?php } ?>
	...
	<table cellspacing="0" class="shop_table shop_table_responsive">
		...
		<?php elseif ( WC()->cart->needs_shipping() && 'yes' === get_option( 'woocommerce_enable_shipping_calc' ) ) : ?>
			...
			<tr class="shipping">
				...
				<td data-title="<?php esc_attr_e( 'Envio', 'visual-composer-starter' ); ?>"><?php woocommerce_shipping_calculator(); ?></td>
			</tr>
