...
?>
	<section class="woocommerce-order-details">
		<div class="vct-order-container">
			<h3 class="woocommerce-order-details__title"><?php esc_html_e( 'Detalles del pedido', 'visual-composer-starter' ); ?></h3>

			<ul class="vct-order-details-container">

				<li class="vct-order-detail">
					<span><?php esc_html_e( 'Número de pedido:', 'visual-composer-starter' ); ?></span>
					<span><?php echo esc_html( $order->get_order_number() ); ?></span>
				</li>
				<li class="vct-order-detail">
					<span><?php esc_html_e( 'Fecha:', 'visual-composer-starter' ); ?></span>
					<span>
						<?php
