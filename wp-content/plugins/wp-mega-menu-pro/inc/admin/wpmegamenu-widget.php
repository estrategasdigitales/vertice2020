...
public function widget($args, $instance) {
    ...
    $wpl_title_color = isset($instance['wpmmplist_title_color'])?$instance['wpmmplist_title_color']:'';
    $wpl_desc_color = isset($instance['wpmmplist_desc_color'])?$instance['wpmmplist_desc_color']:'';
    $wpl_catprice_color = isset($instance['wpmmplist_catprice_color'])?$instance['wpmmplist_catprice_color']:'';
...
<div class="wpmm-pro-productlist-wrap">
    <div class="wpmmstore-container">
        <div id="product-list" class="product-list-area clearfix">
           ...
           <ul class="all-product-list wpmm-<?php echo $image_layout;?> <?php echo 'wpmm-prodlist-col'.$total_column;?>">
            <?php
                 ...
                 <div class="wpmm-prodimage">
                    ...
                    if(isset($product_show_image) && $product_show_image ==1){
                      ...
                      if ( ! empty( $large_image_url[0] ) ) {
                       echo '<a href="' . get_the_permalink() . '" title="' . the_title_attribute( array( 'echo' => 0 ) ) . '">';
                       if($image_size != "custom_size"){
      ...
      if(isset($product_show_category) && $product_show_category == 1){
          if($product_type == "category" && $product_category != 'all'){
            ...
            <span class="product_category_title">
             <a href="<?php echo esc_url( get_category_link( $termid ) );?>" alt="<?php echo
             esc_attr( sprintf( __( 'View all posts in %s', APMM_PRO_TD ), $termname ) );?>">
             <?php echo $termname; ?>
         </a>
     </span>
 <?php }else{
   ...
   if(isset($prod_terms) && !empty($prod_terms)){ ?>
       ...
       foreach ($prod_terms as $key => $value) {
        ...
        echo "<a href='".esc_url( get_category_link( $value -> term_id ) ) ."' alt='".esc_attr( sprintf( __( 'View all posts in %s', APMM_PRO_TD ), $category -> name ) )."'>";
        echo $value->name;
        echo "</span>";
    }?>
    <?php
...
<style>
   .wpmm-woo-content .woocommerce-loop-product__title{
       color: <?php echo $wpl_title_color;?>;
   }
   .product-desc .all-product-desc{
     color: <?php echo $wpl_desc_color;?>;
 }
 .wpmm-pro-productlist-wrap .all-product-list li .wpmm-second-wrapper .wpmm-woo-content a.button{
  background:<?php echo $wpl_atcbtncolor;?>;
  border:<?php echo $wpl_atcbtncolor;?>;
  color:<?php echo $wpl_atcbtnfontcolor;?>;
}
.wpmm-pro-productlist-wrap .all-product-list li .wpmm-second-wrapper .wpmm-woo-content a.button:hover{
  background:<?php echo $wpl_atcbtnhcolor;?>;
  border:<?php echo $wpl_atcbtnhcolor;?>;
  color:<?php echo $wpl_atcbtnfonthcolor;?>;
}
.wpmm-second-wrapper .wpmm-woo-content .price,
.wpmm-second-wrapper .wpmm-woo-content .woocommerce-Price-amount,
.product_category_title a{
  color:<?php echo $wpl_catprice_color;?> !important;
}
</style>
</div><!-- End Products -->
<?php
...
public function update( $new_instance, $old_instance ) {
    ...
    $instance['wpmmplist_title_color'] =  strip_tags( $new_instance['wpmmplist_title_color'] );
    $instance['wpmmplist_desc_color'] =  strip_tags( $new_instance['wpmmplist_desc_color'] );
    $instance['wpmmplist_catprice_color'] =  strip_tags( $new_instance['wpmmplist_catprice_color'] );
                        ...
                        <label for="<?php echo $this->get_field_id('image_size'); ?>">
                          ...
                          <p>
                            <label for="<?php echo $this->get_field_id('image_layout'); ?>">
                                ...
                                <p>
                                    <label for="<?php echo $this->get_field_id('total_column'); ?>">
                                        <?php _e('Total Column',APMM_PRO_TD)?>:</label>
                                        <select name="<?php echo $this->get_field_name('total_column'); ?>"
                                            id="<?php echo $this->get_field_id('total_column'); ?>" class="widefat">
                                            <option value="1" <?php selected('1', $total_column_value); ?>>1</option>
                                            <option value="2" <?php selected('2', $total_column_value); ?>>2</option>
                                            <option value="3" <?php selected('3', $total_column_value); ?>>3</option>
                                            <option value="4" <?php selected('4', $total_column_value); ?>>4</option>
                                            <option value="5" <?php selected('5', $total_column_value); ?>>5</option>
                                            <option value="6" <?php selected('6', $total_column_value); ?>>6</option>
                                        </select>
                                    </p>
                                    <p class="description">Set total number of post for each column. If not set, default will be 2.</p>

                                    <h3>Custom Styling</h3>
                                    <?php
                                    $wpmmplist_title_color =  (isset($instance['wpmmplist_title_color']))?$instance['wpmmplist_title_color']:'';
                                    $wpmmplist_desc_color =  (isset($instance['wpmmplist_desc_color']))?$instance['wpmmplist_desc_color']:'';
                                    $wpmmplist_catprice_color =  (isset($instance['wpmmplist_catprice_color']))?$instance['wpmmplist_catprice_color']:'';
                                    ...
                                    ?>
                                    <p>
                                      <label for="<?php echo $this->get_field_id('wpmmplist_title_color');?>"><?php _e('Title Color',APMM_PRO_TD)?></label>
                                      <input type="text" class="widefat apmm-color-picker" id="<?php echo $this->get_field_id( 'wpmmplist_title_color' ); ?>"
                                      name="<?php echo $this->get_field_name( 'wpmmplist_title_color' ); ?>" data-alpha="true" value="<?php echo esc_attr( $wpmmplist_title_color ); ?>"/>
                                  </p>
                                  <p>
                                      <label for="<?php echo $this->get_field_id('wpmmplist_desc_color');?>"><?php _e('Description Color',APMM_PRO_TD)?></label>
                                      <input type="text" class="widefat apmm-color-picker" id="<?php echo $this->get_field_id( 'wpmmplist_desc_color' ); ?>"
                                      name="<?php echo $this->get_field_name( 'wpmmplist_desc_color' ); ?>" data-alpha="true" value="<?php echo esc_attr( $wpmmplist_desc_color ); ?>"/>
                                  </p>
                                  <p>
                                      <label for="<?php echo $this->get_field_id('wpmmplist_catprice_color');?>"><?php _e('Category/Price Color',APMM_PRO_TD)?></label>
                                      <input type="text" class="widefat apmm-color-picker" id="<?php echo $this->get_field_id( 'wpmmplist_catprice_color' ); ?>"
                                      name="<?php echo $this->get_field_name( 'wpmmplist_catprice_color' ); ?>" data-alpha="true" value="<?php echo esc_attr( $wpmmplist_catprice_color ); ?>"/>
                                  </p>
                                  <p>
                                      <label for="<?php echo $this->get_field_id('addtocartbtncolor');?>"><?php _e('Add To Cart Background Color',APMM_PRO_TD)?></label>
                                      <input type="text" class="widefat apmm-color-picker" id="<?php echo $this->get_field_id( 'addtocartbtncolor' ); ?>"
                                      name="<?php echo $this->get_field_name( 'addtocartbtncolor' ); ?>" data-alpha="true" value="<?php echo esc_attr( $addtocartbtncolor ); ?>"/>
                                  </p>
                                  <p>
                                      <label for="<?php echo $this->get_field_id('addtocartbtnhcolor');?>"><?php _e('Add To Cart Background Hover Color',APMM_PRO_TD)?></label>
                                      <input type="text" class="widefat apmm-color-picker" id="<?php echo $this->get_field_id( 'addtocartbtnhcolor' ); ?>"
                                      name="<?php echo $this->get_field_name( 'addtocartbtnhcolor' ); ?>" data-alpha="true" value="<?php echo esc_attr( $addtocartbtnhcolor ); ?>"/>
                                  </p>
                                  <p>
                                      <label for="<?php echo $this->get_field_id('addtocartbtnfontcolor');?>"><?php _e('Add To Cart Font Color',APMM_PRO_TD)?></label>
                                      <input type="text" class="widefat apmm-color-picker" id="<?php echo $this->get_field_id( 'addtocartbtnfontcolor' ); ?>"
                                      name="<?php echo $this->get_field_name( 'addtocartbtnfontcolor' ); ?>" data-alpha="true" value="<?php echo esc_attr( $addtocartbtnfontcolor ); ?>"/>
                                  </p>
                                  <p>
                                      <label for="<?php echo $this->get_field_id('addtocartbtnfonthcolor');?>"><?php _e('Add To Cart Font Hover Color',APMM_PRO_TD)?></label>
                                      <input type="text" class="widefat apmm-color-picker" id="<?php echo $this->get_field_id( 'addtocartbtnfonthcolor' ); ?>"
                                      name="<?php echo $this->get_field_name( 'addtocartbtnfonthcolor' ); ?>" data-alpha="true" value="<?php echo esc_attr( $addtocartbtnfonthcolor ); ?>"/>
                                  </p>
                                   ...
                                   if(isset($category_detail) && !empty($category_detail )){ ?>
                                       <div class="wpmm-posts-category-lists">
                                          <span class='wpmm-cat'>
                                              ...
                                              $i = 1; foreach($category_detail as $cd){
                                               echo $cd->name;
                                               if($i < $catecount){
                                                  echo ",";
                                              }
          ...
          <div class="wpmmpro-posts-list <?php echo 'wpmm-'.$posts_layout_type;?>">
            ...
            if($query->have_posts()) { while ($query->have_posts()) : $query->the_post();
                ...
                $author_name = get_the_author();
                                       ...
                                       if($posts_layout_type == "layout1"){
                                           if ( ! empty( $large_image_url[0] ) ) { ?>
                                               <div class="wpmmpro_post_img">
                                                 <img src="<?php echo esc_url( $large_image_url[0] );?>" alt="<?php echo $posts_name;?>"/>
                                             </div>
                                         <?php }
                                     }
                                     ?>

                                     <?php if($show_cat_name == 1){
                                         if($posts_layout_type == "layout3"){
                                            if($catfcolor != ''){?>
                                              <div class="show-category" style='border-bottom:1px solid <?php echo $catfcolor;?>'>
                                              <?php }else{ ?>
                                                  ...
                                                  if($posts_layout_type == "layout1" || $posts_layout_type == "layout2"){
                                                    if($catbgcolor != '' || $catfcolor != ''){
                                                      echo "<span class='wpmm-cat' style='background:".$catbgcolor.";color:".$catfcolor."'>";
                                                  }else{
                                                     echo "<span class='wpmm-cat'>";
                                                 }
                                                 $j = 1;
                                                 foreach($category_detail as $cdd){
                                                     echo $cdd->name;
                                                     if($j < $catcount){
                                                        echo ",";
                                                    }
                                               ...
                                               if($catfcolor != ''){
                                                  echo "<span class='wpmm-cat' style='color:".$catfcolor."'>";
                                              }else{
                                                 echo "<span class='wpmm-cat'>";
                                             }
                                             $j = 1;
                        ...
                        <span class="wpmm-posts-title" style="color:<?php echo $ptitle_color;?>"><?php echo $posts_name; ?></span>

                        <div class="posts-extra-details" style="color:<?php echo $content_color;?>">
                          <?php
                          if(isset($show_author_name) && $show_author_name == 1){?>
                            <span class="wpmm-author-name"><span style="color:<?php echo $content_color;?>">by</span> <?php echo $author_name; ?></span>
                        <?php }

                        ?>
                        <?php if(isset($posts_layout_type) && $posts_layout_type != "layout3"){
                           if($show_added_date == 1){?>
                            <span class="wpmm-entry-date"><span style="color:<?php echo $content_color;?>">on</span> <?php echo get_the_date(); ?></span>
                        <?php }
                        if($show_comment_number == 1){
                            $my_var = get_comments_number( $posts_id );?>
                            <span class="comment_in_number" style="color:<?php echo $content_color;?>"><?php echo $my_var; ?></span>
                        <?php }
                    } ?>
                </div>
             ...
             <?php if(isset($enable_excerpt) && $enable_excerpt == 1){
                 $desc = WPMM_Libary::wpmm_get_excerptbyid(get_the_ID(),$post_length);?>
                 <div class="wpmmpro_post_content" style="color:<?php echo $content_color;?>">
                  <p style="color:<?php echo $content_color;?>"><?php echo $desc;?></p>
              </div>
          <?php } ?>
          <?php if(isset($enable_button)  && $enable_button == 1 && $button_name != ''){ ?>
           ...
           <div class="posts-last-section">
               ...
               if(isset($enable_button) && $enable_button == 1 && $button_name != ''){
                  if($posts_layout_type == "layout1" || $posts_layout_type == "layout2"){
                    if($btnbgcolor != ''){ ?>
                       <span style="background-color:<?php echo $btnbgcolor;?>;border:1px solid <?php echo $btnbgcolor;?>;">
               ...
               if($btnfcolor != ''){ ?>
                 <span style="color:<?php echo $btnfcolor;?>"><?php echo $button_name;?>
             </span>
         <?php }else{
          echo "<span>".$button_name."</span>";
      }
...
<?php if(isset($posts_layout_type) && $posts_layout_type == "layout3"){
   if($show_added_date == 1){?>
       <span class="wpmm-entry-date" style="color:<?php echo $content_color;?>"><?php echo get_the_date(); ?></span>
   <?php }
   if($show_comment_number == 1){
    $my_var = get_comments_number( $posts_id );?>
    <span class="comment_in_number" style="color:<?php echo $content_color;?>"><?php echo $my_var; ?></span>
...
<p>
    ...
    <p>
      ...
      <h3>Custom Styling</h3>
      <div class="wpmmpro-widget-layout-options" data-option="12_Layout" <?php if($posts_layout_type === "layout3") echo 'style="display:none;"';?>>
       <p>
          <label for="<?php echo $this->get_field_id('btnbgcolor');?>"><?php _e('Button Background Color',APMM_PRO_TD)?></label>
          <input type="text" class="widefat apmm-color-picker" id="<?php echo $this->get_field_id( 'btnbgcolor' ); ?>"
          name="<?php echo $this->get_field_name( 'btnbgcolor' ); ?>" data-alpha="true" value="<?php echo esc_attr( $btnbgcolor ); ?>"/>
      </p>
  </div>
      <!--    <div class="wpmmpro-widget-layout-options" data-option="12_Layout" <?php if($posts_layout_type === "layout3") echo 'style="display:none;"';?>>
         <p>
          <label for="<?php echo $this->get_field_id('btnbghcolor');?>"><?php _e('Button Background Hover Color',APMM_PRO_TD)?></label>
         <input type="text" class="widefat apmm-color-picker" id="<?php echo $this->get_field_id( 'btnbghcolor' ); ?>"
         name="<?php echo $this->get_field_name( 'btnbghcolor' ); ?>" data-alpha="true"  value="<?php echo esc_attr( $btnbghcolor ); ?>"/>
         </p>
     </div> -->
     <div class="wpmmpro-widget-layout-options" data-option="12_Layout" <?php if($posts_layout_type === "layout3") echo 'style="display:none;"';?>>
       <p>
          <label for="<?php echo $this->get_field_id('catbgcolor');?>"><?php _e('Category Background Color',APMM_PRO_TD)?></label>
          <input type="text" class="widefat apmm-color-picker" id="<?php echo $this->get_field_id( 'catbgcolor' ); ?>"
          name="<?php echo $this->get_field_name( 'catbgcolor' ); ?>" data-alpha="true"  value="<?php echo esc_attr( $catbgcolor ); ?>"/>
      </p>
  </div>
  <div class="wpmmpro-widget-layout-options" data-option="123_Layout">
   <p>
      <label for="<?php echo $this->get_field_id('catfcolor');?>"><?php _e('Category Font Color',APMM_PRO_TD)?></label>
      <input type="text" class="widefat apmm-color-picker" id="<?php echo $this->get_field_id( 'catfcolor' ); ?>"
      name="<?php echo $this->get_field_name( 'catfcolor' ); ?>" data-alpha="true"  value="<?php echo esc_attr( $catfcolor ); ?>"/>
  </p>
</div>
<div class="wpmmpro-widget-layout-options" data-option="123_Layout">
   <p>
      <label for="<?php echo $this->get_field_id('btnfcolor');?>"><?php _e('Button Font Color',APMM_PRO_TD)?></label>
      <input type="text" class="widefat apmm-color-picker" id="<?php echo $this->get_field_id( 'btnfcolor' ); ?>"
      name="<?php echo $this->get_field_name( 'btnfcolor' ); ?>" value="<?php echo esc_attr( $btnfcolor ); ?>"/>
  </p>
</div>
    <!--      <div class="wpmmpro-widget-layout-options" data-option="123_Layout">
         <p>
          <label for="<?php echo $this->get_field_id('btnfhcolor');?>"><?php _e('Button Font Hover Color',APMM_PRO_TD)?></label>
         <input type="text" class="widefat apmm-color-picker" id="<?php echo $this->get_field_id( 'btnfhcolor' ); ?>"
         name="<?php echo $this->get_field_name( 'btnfhcolor' ); ?>" value="<?php echo esc_attr( $btnfhcolor ); ?>"/>
         </p>
     </div> -->
     <div class="wpmmpro-widget-layout-options" data-option="123_Layout">
       <p>
          <label for="<?php echo $this->get_field_id('ptitle_color');?>"><?php _e('Posts Title Color',APMM_PRO_TD)?></label>
          <input type="text" class="widefat apmm-color-picker" id="<?php echo $this->get_field_id( 'ptitle_color' ); ?>"
          name="<?php echo $this->get_field_name( 'ptitle_color' ); ?>" value="<?php echo esc_attr( $ptitle_color ); ?>"/>
      </p>
  </div>
  <div class="wpmmpro-widget-layout-options" data-option="123_Layout">
   <p>
      <label for="<?php echo $this->get_field_id('content_color');?>"><?php _e('Content Color',APMM_PRO_TD)?></label>
      <input type="text" class="widefat apmm-color-picker" id="<?php echo $this->get_field_id( 'content_color' ); ?>"
      name="<?php echo $this->get_field_name( 'content_color' ); ?>" value="<?php echo esc_attr( $content_color ); ?>"/>
  </p>
</div>
        ...
        <ul>
            ...
            <li>
             ...
             if ( ! empty( $imageurl[0] ) ) {
              ...
              echo "<div class='wpmm-featured' style='width=".$width."'>";
              echo "<img src='".APMM_PRO_IMG_DIR."/thumbnail-default.jpg' alt='".the_title_attribute( array( 'echo' => 0 ) )."'/>";
              echo "</div>";
          }
          ?>
...
public function widget($args, $instance) {
   ...
   <div class="wpmm-header">
    <?php if($sub_title != ''){ ?>
        <h2 class="entry-title"><a href="<?php echo esc_url($url_link);?>" target="<?php echo esc_attr($textwidget_url_target);?>">
        ...
        <?php } ?>
        <?php if($button_name != ''){ ?>
            <div class="wwpmm-linkbtn"><a href="<?php echo esc_url($url_link);?>" target="<?php echo esc_attr($textwidget_url_target);?>"><?php echo esc_attr($button_name);?></a></div>
        <?php } ?>
    </div>
</div>
<?php
...
public function form( $instance ) {
  ...
  <p>
      <label for="<?php echo $this->get_field_id('url_target');?>"><?php _e('Choose Target',APMM_PRO_TD)?></label>
      <select name="<?php echo $this->get_field_name('url_target'); ?>" class="widefat">
       <option value="_self"  <?php selected('_self', $url_target); ?>><?php _e('_self',APMM_PRO_TD);?></option>
       <option value="_blank"  <?php selected('_blank', $url_target); ?>><?php _e('_blank',APMM_PRO_TD);?></option>
       <option value="_parent" <?php selected('_parent', $url_target); ?>><?php _e('_parent',APMM_PRO_TD);?></option>
       <option value="_top"  <?php selected('_top', $url_target); ?>><?php _e('_top',APMM_PRO_TD);?></option>
   </select>
</p>
<p>
