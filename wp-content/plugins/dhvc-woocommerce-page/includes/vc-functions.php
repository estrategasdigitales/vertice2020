...
function dhvc_woo_product_page_access_check_shortcode_edit( $null, $shortcode ){
	...
	$post_type_setting =  dhvc_woo_page_get_option('dhvc_woo_page_template_type','dhwc_template');
	if( 'vc_edit_form' === vc_request_param('action') || $post_type_setting === get_post_type($post_id) || dhvc_woo_product_page_is_page_editable()){
		return $null;
