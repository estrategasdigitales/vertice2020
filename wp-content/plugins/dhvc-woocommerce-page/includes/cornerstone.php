...
class DHVC_Woo_Page_Cornerstone{
	...
	public function register_elements(){
		...
		cornerstone_register_element('dhvc_woo_product_page_sku','dhvc_woo_product_page_sku',DHCS_WOO_PAGE_CS_ELEMENT_DIR.'/sku');
		cornerstone_register_element('dhvc_woo_product_page_term','dhvc_woo_product_page_term',DHCS_WOO_PAGE_CS_ELEMENT_DIR.'/term');
