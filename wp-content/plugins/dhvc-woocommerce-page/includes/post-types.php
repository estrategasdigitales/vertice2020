...
class DHVC_Woo_Page_Post_Types {
	...
	public static function need_public(){
		if(isset($_GET['cornerstone'])
			|| isset($_GET['cornerstone_preview'])
			|| isset($_POST['cs_preview_state'])
			|| (is_plugin_active('cornerstone/cornerstone.php') && is_admin())
		){
			return true;
		}
		return false;
	...
	public static function register_post_types()
	{
		...
		register_post_type('dhwc_template',array(
			...
			'public' => self::need_public(),
			'has_archive' => false,
			'show_in_nav_menus' => false,
			'exclude_from_search' => true,
			'publicly_queryable' => self::need_public(),
			'show_ui' => true,
		...
		register_post_type('dhwc_page_template',array(
			'labels' => array(
				'name' => __('Page Templates', DHVC_WOO_PAGE),
				'singular_name' => __('Page Template', DHVC_WOO_PAGE),
				'menu_name' => _x('Page Template', 'Admin menu name', DHVC_WOO_PAGE),
				'add_new' => __('Add Page Template', DHVC_WOO_PAGE),
				'add_new_item' => __('Add New Page Template', DHVC_WOO_PAGE),
				'edit' => __('Edit', DHVC_WOO_PAGE),
				'edit_item' => __('Edit Page Template', DHVC_WOO_PAGE),
				'new_item' => __('New Page Template', DHVC_WOO_PAGE),
				'view' => __('View Page Template', DHVC_WOO_PAGE),
				'view_item' => __('View Page Template', DHVC_WOO_PAGE),
				'search_items' => __('Search Page Templates', DHVC_WOO_PAGE),
				'not_found' => __('No Page Templates found', DHVC_WOO_PAGE),
				'not_found_in_trash' => __('No Page Templates found in trash', DHVC_WOO_PAGE),
				'parent' => __('Parent Page Template', DHVC_WOO_PAGE)
			),
			'public' => false,
			'has_archive' => false,
			'show_in_nav_menus' => false,
