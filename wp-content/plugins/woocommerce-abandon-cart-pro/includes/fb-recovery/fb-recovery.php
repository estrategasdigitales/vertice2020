        ...
        public static function wcap_send_fb_message( $cart_data, $template_data ) {
            ...
            if ( isset( $cart_info->wcap_user_ref ) && $cart_info->wcap_user_ref != '' ) {
                ...
                if ( isset( $template_data['subject'] ) && $template_data['subject'] != '' ) {
                    ...
                    $trans_subject     = Wcap_Send_Email_Using_Cron::wcap_get_translated_texts( $name_msg, $template_data['subject'], $selected_language );
                ...
                $trans_body = Wcap_Send_Email_Using_Cron::wcap_get_translated_texts( $name_msg, $template_data['body'], $selected_language );
