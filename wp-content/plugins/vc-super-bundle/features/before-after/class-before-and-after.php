	...
	class GambitBeforeAndAfterShortcode {
		...
		public function create_shortcode() {
			...
			vc_map( array(
				...
				'icon' => plugins_url( 'before-and-after/images/vc-icon.png', __FILE__ ),
		...
		public function render_shortcode( $atts, $content = null ) {
			...
			$after_medium = wp_get_attachment_image_src( $atts['after_image_id'], $size_medium );
			$before_medium = wp_get_attachment_image_src( $atts['before_image_id'], $size_medium );
