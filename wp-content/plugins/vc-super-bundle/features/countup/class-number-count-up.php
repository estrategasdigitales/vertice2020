	...
	class Number_Count_Up_Shortcode {
		...
		public function create_shortcode() {
			...
			vc_map( array(
				...
				'params' => array(
					...
					array(
						'type' => 'colorpicker',
						'heading' => __( 'Number Count Up Text Font Color', GAMBIT_VC_TEXT_EFFECTS ),
					...
					array(
						'type' => 'colorpicker',
						'heading' => __( 'Heading Font Color', GAMBIT_VC_TEXT_EFFECTS ),
					...
					array(
						'type' => 'colorpicker',
						'heading' => __( 'Description Text Color', GAMBIT_VC_TEXT_EFFECTS ),
		...
		public function render_shortcode( $atts, $content = '' ) {
			...
			$output = '<div class="number-count-up-vc" style="' . esc_attr( implode( '; ', $style ) ) . '">
							...
							' <div class="number-counter wpb_animate_when_almost_visible" data-delay="' . esc_attr( (int) $atts['animation_delay'] ) . '" data-duration="' . esc_attr( $atts['animation_speed'] ) . '"  style="' . esc_attr( implode( '; ', $countUpStyle ) ) . '">
							' . $content . '</div>
