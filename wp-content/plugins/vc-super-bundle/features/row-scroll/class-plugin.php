...
defined( 'VERSION_GAMBIT_ROW_SCROLL' ) || define( 'VERSION_GAMBIT_ROW_SCROLL', '1.2' );

// Initializes the plugin translations.
defined( 'GAMBIT_ROW_SCROLL' ) || define( 'GAMBIT_ROW_SCROLL', 'row-scroll-animations' );

// This is the main plugin functionality.
require_once( 'class-row-scroll.php' );
