...
*/
	...
	public function frontend_styles() {
		...
		wp_register_style( 'iconic-was-styles', ICONIC_WAS_URL . 'assets/frontend/css/main' . $suffix . '.css', array( 'dashicons' ), self::$version );
	...
	public function frontend_scripts() {
		...
		$vars = apply_filters( 'iconic_was_script_vars', array(
			'ajaxurl'  => admin_url( 'admin-ajax.php' ),
			'nonce'    => wp_create_nonce( $this->slug ),
			'currency' => array(
				'format_num_decimals' => 0,
