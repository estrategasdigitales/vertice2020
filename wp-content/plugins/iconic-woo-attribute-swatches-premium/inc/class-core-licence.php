...
if ( class_exists( 'Iconic_WAS_Core_Licence' ) ) {
    return;
}
/**
 * Iconic_WAS_Core_Licence.
 *
...
class Iconic_WAS_Core_Licence
{
    ...
    {
        return $html . sprintf( '<a href="%s" class="button button-secondary">&larr; %s</a>', self::$args['urls']['settings'], __( 'Back to Settings', 'iconic-was' ) );
    }
    ...
    {
        if ( !Iconic_WAS_Core_Settings::is_settings_page( '-account' ) ) {
            return;
        }
        ?>
    ...
    {
        $links[] = sprintf( '<a href="%s" target="_blank">%s</a>', self::$args['urls']['product'] . '/changelog/?utm_source=plugin&utm_medium=iconic-was&utm_campaign=changelog-link', __( 'Changelog', 'iconic-was' ) );
        return $links;
    }
    ...
    {
        return sprintf( '<a href="%s" class="button button-secondary">%s</a>', self::$args['urls']['account'], __( 'Manage Licence &amp; Billing', 'iconic-was' ) );
    }
