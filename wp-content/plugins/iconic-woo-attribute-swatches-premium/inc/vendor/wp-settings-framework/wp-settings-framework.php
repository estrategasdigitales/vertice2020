...
if ( ! class_exists( 'Iconic_WAS_Settings_Framework' ) ) {
	/**
	 * Iconic_WAS_Settings_Framework class
	 */
	class Iconic_WAS_Settings_Framework {
		/**
		 * @access private
		 * @var array
		 */
		...
		/**
		 * Iconic_WAS_Settings_Framework constructor.
		 *
