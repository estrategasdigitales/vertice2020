...
class __TwigTemplate_88f72fe03393954e4bc10f9315b0c5c5be52c51a1479b768cb09ea8320aa26cf extends \WPML\Core\Twig\Template
{
...
<p>
    <label>
        ...
        echo " />&nbsp;";
        echo \WPML\Core\twig_escape_filter($this->env, $this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "label_mco", []), "html", null, true);
        echo "
    </label>
</p>
...
<p class=\"wcml-setup-actions step\">
    ...
    {
        return new Source("", "/setup/multi-currency.twig", "/Applications/MAMP/htdocs/mool/wp-content/plugins/woocommerce-multilingual/templates/setup/multi-currency.twig");
    }
}
