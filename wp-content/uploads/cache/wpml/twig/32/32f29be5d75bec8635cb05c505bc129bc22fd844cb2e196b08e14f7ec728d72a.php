...
/* custom-files.twig */
class __TwigTemplate_ce44c36b0ec4a112af6191cc48db6074cf3f6ba44b4315436ab082169d1fd81a extends \WPML\Core\Twig\Template
{
...
<div class=\"wcml-downloadable-options\">
    ...
    <input type=\"checkbox\" name=\"wcml_file_path_option[";
        // line 7
        echo \WPML\Core\twig_escape_filter($this->env, (isset($context["product_id"]) ? $context["product_id"] : null), "html", null, true);
    ...
    <label for=\"wcml_file_path_option\">";
        // line 8
        echo \WPML\Core\twig_escape_filter($this->env, $this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "use_custom", []), "html", null, true);
        echo "</label>
    ...
    <ul ";
        ...
        // line 14
        echo \WPML\Core\twig_escape_filter($this->env, $this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "use_same", []), "html", null, true);
        echo "</label>
        </li>
        <li>
            <input type=\"radio\" name=\"wcml_file_path_sync[";
        ...
        // line 19
        echo \WPML\Core\twig_escape_filter($this->env, $this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "separate", []), "html", null, true);
        echo "</label>
        </li>
    </ul>
    <p></p>
...
";
    ...
    {
        return new Source("", "custom-files.twig", "/Applications/MAMP/htdocs/mool/wp-content/plugins/woocommerce-multilingual/templates/custom-files.twig");
    }
}
